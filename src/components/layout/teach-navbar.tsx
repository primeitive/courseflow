...
const NAV_ITEMS: NavItem[] = [
  {
    label: "Courses",
    icon: BookOpen,
    route: { name: "teach-courses" },
    match: ["teach-courses", "teach-course-edit"],
  },
  {
    label: "Revenue",
    icon: DollarSign,
    route: { name: "teach-revenue" },
    match: ["teach-revenue"],
  },
];

export function TeachNavbar() {
        ...
        <div className="ml-auto flex items-center gap-1 sm:gap-2">
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-[300px]">
              <SheetHeader>
                <SheetTitle>Teach menu</SheetTitle>
              </SheetHeader>
              <div className="mt-6 flex flex-col gap-2">
                ...
                <Button
                  ...
                  onClick={() => go({ name: "home" })}
                >
                  <GraduationCap className="mr-2 h-4 w-4" /> Switch to student
                </Button>
                <Button
                  variant="ghost"
